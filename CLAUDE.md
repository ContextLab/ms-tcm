...
- **Numerical sanity check from the spec**: with β_G = β_S = 0.5, m = 3, w_G = 0.2, w_S = 0.8, composite similarity is 0.866 (grouped) vs 0.806 (bridge). New code should reproduce these numbers before being trusted.
